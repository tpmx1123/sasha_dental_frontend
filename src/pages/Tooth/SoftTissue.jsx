...
import SoftTissueImg from "../../components/assets/Tooth/Soft Tissue Excision.svg";

export default function SoftTissue() {
  const points = [
    "Enhances comfort and oral function",
    "Improves soft tissue health",
    "Can be used for biopsy or diagnosis",
  ];
  ...
  return (
    <section className="px-4 py-10 md:py-16 bg-white lg:-mt-6">
      <div className="max-w-[1150px] mx-auto">
        ...
        >
          ...
          <motion.div variants={fadeUp} className="md:mt-16 order-2 lg:order-1">
            <h3
              ...
              style={{ color: "#0267AC" }}
            >
              Soft Tissue Excision (Per Tooth)
            </h3>
            ...
            Remove abnormal or excess gum tissue, fibromas, or overgrowths that interfere 
            with comfort, hygiene, or aesthetics.
            </p>
        ...
        >
          {[
            "Gentle surgical removal with minimal trauma",
            "Quick healing, often without stitches",
            "May be combined with laser therapy for added precision",
          ].map((text, idx) => (
            <motion.div
              key={idx}
              variants={fadeUp}
