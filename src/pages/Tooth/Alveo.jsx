...
import CystImg from "../../components/assets/Tooth/Alveoloplasty-1.svg";
import ArrowIcon from "../../components/assets/Tooth/ARROW.svg";

export default function Alveo() {
  const points = [
    "Prepares bone for restorations",
    "Reduces sharp ridges or irregularities",
    ...
    <section className="px-4 py-10 md:py-16 bg-white lg:-mt-6">
      <div className="max-w-[1220px] mx-auto">
        ...
        >
          ...
          >
            <h3
              className="font-extrabold text-[18px] sm:text-2xl lg:text-[28px] mb-3 md:mb-5 "
              style={{ color: "#0267AC" }}
            >
              Alveoloplasty (Per Tooth)
            </h3>
            <p className="text-gray-700 text-[14px] sm:text-[16px] lg:text-[20px] leading-7 lg:leading-[38px] tracking-wide mb-4">
            Bone reshaping to smooth or contour the jawbone following extractions or before 
            prosthetics. This enhances denture fit, implant success, and soft tissue healing.
            </p>
        ...
        >
          {[
            ...
            "Often done alongside or after extractions",
            "Short recovery with mild tenderness",
          ].map((text, idx) => (
            <motion.div
              key={idx}
              variants={fadeUp}
