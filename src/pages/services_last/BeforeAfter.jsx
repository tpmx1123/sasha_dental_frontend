...
export default function BeforeAfter() {
  ...
  const beforeInstructions = [
    "Avoid colored foods/drinks  for 24 hours",
    "Brush and floss gently",
    " Inform us of any sensitivity"
   

  ];

  const afterInstructions = [
    "Avoid coffee, red wine, or smoking for 48 hours",
    " Use a straw when drinking beverages",
    " Maintain with a whitening  toothpaste or touch-up kit"
   
  ];

  return (
    <div className="py-8 md:py-16 px-4 bg-white lg:-mt-4">
      <div className="max-w-[1000px] mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-5 -mt-6">
          ...
          >
            <motion.h3 
              className="font-bold mb-3 md:mb-4 text-lg md:text-2xl lg:text-[28px]" 
              style={{color: '#0267AC'}}
