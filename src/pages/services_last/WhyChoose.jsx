...
export default function WhyChoose() {
  ...
  const features = [
    ...
    {
      icon: TrustedIcon,
      text: " Relaxing, spa-like dental environment"

    },
    {
        icon: HighQualityIcon,
        text: "Latest technology and premium materials"

    },
    {
      icon: GentleTechIcon,
      text: " Trusted by professionals, brides, and beauty-conscious clients"
            ...
            >
              <div className="flex items-center">
                ...
                <div className="flex-1">
                  <motion.p 
                    className="text-gray-700 font-medium leading-relaxed text-[15px] sm:text-[18px]" 
